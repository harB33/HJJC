...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2025 at 11:21 AM
...
INSERT INTO `product_details` (`detail_id`, `product_id`, `cart_id`, `temperature`, `milk_type`, `espresso_shots`, `sweetness`, `ice_level`, `created_at`) VALUES
(2, 3, 1, 'Hot', 'Oat Milk', 'LYDIA', 'Regular Sweet', 'Normal Ice', '2025-11-11 10:07:36');
...
ALTER TABLE `product_details`
  ...
  ADD CONSTRAINT `product_details_ibfk_2` FOREIGN KEY (`cart_id`) REFERENCES `cart` (`cart_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
