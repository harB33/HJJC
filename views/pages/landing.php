...
<body class="w-screen overflow-x-clip min-h-screen">
    ...
    <section class="grid grid-cols-12 size-screen">
        ...
        <section class="col-start-1 grid grid-cols-12 w-screen py-32 bg-custom-primary">
