    ...
    <header class="fixed top-0 w-screen flex justify-center z-50 items-center lg:px-5 lg:py-2 max-lg:px-2.5 max-lg:py-0.5  backdrop-blur-2xl">
        <div class="grid md:grid-cols-3 max-lg:grid-cols-2 items-center w-full max-sm:pr-6">
            ...
            <div class="grow items-center flex justify-center md:gap-4 lg:gap-12 max-md:hidden text-nowrap">
                <a href="<?php echo BASE_URL; ?>/" class="text-2xl font-urbanist italic font-medium text-zinc-100 border-b-2 border-transparent hover:border-custom-accent transition-all duration-300">Home</a>
                <a href="<?php echo BASE_URL; ?>/home" class="text-2xl font-urbanist italic font-medium text-zinc-100 border-b-2 border-transparent hover:border-custom-accent transition-all duration-300">Products</a>
                <a href="#" class="text-2xl font-urbanist italic font-medium text-zinc-100 border-b-2 border-transparent hover:border-custom-accent transition-all duration-300">About Us</a>
                <a href="#" class="text-2xl font-urbanist italic font-medium text-zinc-100 border-b-2 border-transparent hover:border-custom-accent transition-all duration-300">Contact</a>
            </div>
